...
- Most ✅ fixes need the **real source files** (upload them here, or use Claude Code against the local repo) — I can't fix files I can't see. `bug-#006` is the exception: already done in the state-backend scaffold.
